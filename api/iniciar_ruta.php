...
// Garantizar hora local correcta
...
// Capturar la fecha y hora real exacta del momento en que el chofer inicia la ruta
$fecha_inicio = date('Y-m-d H:i:s');

// Actualizar la ruta sobreescribiendo fecha_inicio con la hora real de arranque
